...
| Tipo de Usuario | Usuario  | Contraseña  | Acceso                                    |
|-----------------|----------|-------------|-------------------------------------------|
| Administrador   | `admin`  | `admin123`  | Panel completo con 12+ pestañas          |
| Cliente         | `cliente`| `cliente123`| Sistema de reservas y perfil de usuario  |
